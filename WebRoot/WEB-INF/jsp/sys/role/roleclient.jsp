	...
	<div class="layui-collapse right-user" >
		<c:forEach items="${roleMenuList}" var="menu1">
			<div class="layui-colla-item">
					<lable class="label-1"> <input type="checkbox" data-id="${menu1.funtId }" >
					${menu1.funtName } </lable>
		    		 ...
		    		 <colgroup>
						...
						<c:if test="${not empty menu2.subMenuList}">
							<tr>
								<td class="panel-body">
									<p>
										 <input type="checkbox"  data-id="${menu2.funtId }" ><label>${menu2.funtName }</label>
									</p>
								</td>
								<td class="Privilege-p">
									<c:forEach items="${menu2.subMenuList}" var="menu3">
										 <p><input type="checkbox" data-id="${menu3.funtId }" /><label>${menu3.funtName }</label></p>
									</c:forEach>
								</td>
							</tr>
						</c:if>
