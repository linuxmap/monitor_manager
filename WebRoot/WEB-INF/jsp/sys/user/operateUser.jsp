  	...
  	<div id="dlg" align="center" style="padding:10px 0  20px 0;" >
        <form id="fm" method="post">
        	<input name="userId" id="userId" value="${sysUser.userId}" type="hidden" />
  			...
  			<input name="formtoken" id="formtoken" value="${token}" type="hidden" />     
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                ...
                <tr >
                    <td><label><span style="color: red;">*</span>用户名：</label>
                    	<input type="text" id="loginName" name="loginName" value="${sysUser.loginName}" data-rule-required="true" data-rule-isUserid="true" onchange="validateLoginName()">
                    </td>
                    <td><label><span style="color: red;">*</span>真实姓名：</label>
                    	<input type="text" value="${sysUser.userName }" name="userName" data-rule-required="true" title="请输入真实姓名"/>
                    </td>
                </tr>
                <tr >
                    ...
                    <td><label>座机号：</label><input type="text" value="${sysUser.tell }" name="tell" maxlength="20"/></td>		                    
                </tr>
                <tr >
