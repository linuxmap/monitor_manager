...
<html>
  ...
  <body style="margin-bottom:20px;">
  	<div id="dlg"  style="padding:10px 20px;" >
        <form id="fm" method="post">
  			...
  			<input name="cameraId" id="cameraId" value="${vmsCamera.cameraId}" type="hidden" />
	      ...
	      <fieldset class="bor-form"> 
	       ...
	       <table>  
                <!-- 登录信息 -->
                <tr class="controlLogin" style="display: ${loginDisplay }"> <!-- 设备是否有登录信息，有则显示下拉框，无则不显示 -->
                   <td style="width:150px"><label >通过其他资源登录：</label><!-- 未选中的checkbox和禁用的控件不是有效控件，不会被POST
                    	...
                    	<input type="checkbox" style="border: 0 !important; width:20px;" id="chooseLoginResource2" checked="checked" value="1" name="loginSource" onclick="chooseLoginResource();" style="width:20px;height:18px；border:0 !important;"/>
                    </td>
                    <td id="currentLoginList"><label id="currentLoginList" >选择其他资源：</label>
  ...
  <script type="text/javascript">
    ...
    function save() {
  		...
  		var url = '${sys_ctx}/asset/editAsset.action';
